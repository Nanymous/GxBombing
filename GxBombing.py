...
banner = (Fore.CYAN+"""  ______  __  _      _                     _     _
 / ___\ \/ / ( )    / \   _ __ _ __   ___ | | __| |
| |  _ \  /  |/    / _ \ | '__| '_ \ / _ \| |/ _` |
| |_| |/  \       / ___ \| |  | | | | (_) | | (_| |
 \____/_/\_\     /_/   \_\_|  |_| |_|\___/|_|\__,_|
...
print("")
print("")
Rubik = (Fore.CYAN+"                  ID RUBIKA:@GXArnold")
for Ru in Rubik:
    sys.stdout.write(Ru)
    sys.stdout.flush()
    time.sleep(0.03)
print("")
Rubi = ("                 ID NEW RUBIKA:@GXSigma")
for ru in Rubi:
    sys.stdout.write(ru)
    sys.stdout.flush()
    time.sleep(0.05)
...
# print(id_)
# print(rg)
number = input(Fore.GREEN+'[+] Enter Victim Number ->09')
user_input_loop = int(
